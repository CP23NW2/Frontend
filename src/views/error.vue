<template>
<div class="flex items-center justify-center min-h-screen bg-primary-color  bg-fixed bg-cover bg-bottom error-bg"
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                <span class="absolute top-0 -ml-12 mt-64 text-gray-50 font-semibold text-4xl ">Oops!</span>
				<div class="relative ">
				<h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold text-indigo-700">404</h1>
